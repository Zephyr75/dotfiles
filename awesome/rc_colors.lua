...
local battery_widget = require("awesome-wm-widgets.battery-widget-red.battery")
local cpu_widget = require("awesome-wm-widgets.cpu-widget.cpu-widget")
local ram_widget = require("awesome-wm-widgets.ram-widget-green.ram-widget")
local volume_widget = require("awesome-wm-widgets.volume-widget-blue.volume")
...
awful.spawn.with_shell('export BAT_THEME="Enki-Tokyo-Night"')
