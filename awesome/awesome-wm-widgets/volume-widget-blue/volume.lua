...
-- https://github.com/streetturtle/awesome-wm-widgets/tree/master/volume-widget-blue
...
local utils = require("awesome-wm-widgets.volume-widget-blue.utils")
...
local widget_types = {
    icon_and_text = require("awesome-wm-widgets.volume-widget-blue.widgets.icon-and-text-widget"),
    icon = require("awesome-wm-widgets.volume-widget-blue.widgets.icon-widget"),
    arc = require("awesome-wm-widgets.volume-widget-blue.widgets.arc-widget"),
    horizontal_bar = require("awesome-wm-widgets.volume-widget-blue.widgets.horizontal-bar-widget"),
    vertical_bar = require("awesome-wm-widgets.volume-widget-blue.widgets.vertical-bar-widget")
}
local volume = {}
...
local function worker(user_args)
    ...
    local function update_graphic(widget, stdout)
        ...
        volume_level = string.format("%2d", volume_level)
